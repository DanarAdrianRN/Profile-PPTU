...
@include('components.header')
    ...
    <section class="guru-section">
        <div class="container">
            {{-- TAB --}}
            <div class="nav guru-tabs" id="guruTab" role="tablist">
                <button class="tab-btn active" id="madin-tab" data-toggle="tab" data-target="#madin" type="button">
                    Madrasah Diniyah
                </button>
                <button class="tab-btn" id="smp-tab" data-toggle="tab" data-target="#smp" type="button">
                    SMP
                </button>
                <button class="tab-btn" id="smk-tab" data-toggle="tab" data-target="#smk" type="button">
                    SMK
                </button>
                <button class="tab-btn" id="madqur-tab" data-toggle="tab" data-target="#madqur" type="button">
                    Madrasah Al-Qur'an
                </button>
                <button class="tab-btn" id="tpq-tab" data-toggle="tab" data-target="#tpq" type="button">
                    Taman Pendidikan Al-Qur'an
                </button>
            </div>
            {{-- TAB CONTENT --}}
            <div class="tab-content mt-5" id="guruTabContent">
                {{-- MADIN --}}
                ...
                {{-- SMK --}}
                <div class="tab-pane fade" id="smk" role="tabpanel">
                    <div class="guru-grid">
                ...
                {{-- MADQUR --}}
                <div class="tab-pane fade" id="madqur" role="tabpanel">
                    <div class="guru-grid">
                ...
                {{-- TPQ --}}
                <div class="tab-pane fade" id="tpq" role="tabpanel">
                    <div class="guru-grid">

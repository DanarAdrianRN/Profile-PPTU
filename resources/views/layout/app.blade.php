...
<body class="{{ request()->is('landing*') ? 'landing-page' : '' }}">
    ...
    @isset($galeris)
        {{-- MODAL VIEW GALERI --}}
        @foreach ($galeris as $galeri)
            <div class="modal fade admin-modal" id="modalViewGaleri{{ $galeri->id }}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        {{-- HEADER --}}
    ...
    @isset($galeris)
        <!-- HAPUS MODAL GALERI -->
        @foreach ($galeris as $galeri)
            <div class="modal fade delete-modal" id="modalHapusGaleri{{ $galeri->id }}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
    ...
    @isset($gurus)
        ...
        @foreach ($gurus as $guru)
            <div class="modal fade admin-modal" id="modalEditGuru{{ $guru->id }}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        {{-- HEADER --}}
                            ...
                            <form action="{{ route('guru.update', $guru->id) }}" method="POST"
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_lengkap" value="{{ $guru->nama_lengkap }}">
                                    </div>
                                    {{-- KATEGORI --}}
                                    <div class="form-group">
                                        <label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mapel_bidang" value="{{ $guru->mapel_bidang }}">
                                    </div>
                                    {{-- STATUS --}}
                                    <div class="form-group">
                                        <label>
    ...
    @isset($gurus)
        {{-- MODAL VIEW GURU --}}
        @foreach ($gurus as $guru)
            <div class="modal fade admin-modal" id="modalViewGuru{{ $guru->id }}" tabindex="-1"
                aria-hidden="true">
    ...
    @isset($gurus)
        <!-- HAPUS MODAL GURU -->
        @foreach ($gurus as $guru)
            <div class="modal fade delete-modal" id="modalHapusGuru{{ $guru->id }}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal fade admin-modal" id="modalEditPendaftaran{{ $pendaftaran->id }}" tabindex="-1">
                ...
                "modal-dialog modal-xxl modal-dialog-scrollable modal-dialog-centered">
                    <form action="{{ route('pendaftaran.update', $pendaftaran->id) }}" method="POST"
                        class="modal-content pendaftaran" enctype="multipart/form-data">
                        @csrf
                        <!-- HEADER -->
                        <div class="modal-header">
                            <div class="modal-title-wrap">
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="nama_panggilan" type="text"
                                    ...
                                    <div class="form-group">
                                        <label>Anak Ke</label>
                                        <input name="anak_ke" type="number" value="{{ $pendaftaran->anak_ke }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Jumlah Saudara Kandung</label>
                                        <input name="jumlah_saudara_kandung" type="number"
                                            value="{{ $pendaftaran->jumlah_saudara_kandung }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Jumlah Saudara Angkat</label>
                                        <input name="jumlah_saudara_angkat" type="number"
                                            value="{{ $pendaftaran->jumlah_saudara_angkat }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Jumlah Saudara Tiri</label>
                                        <input name="jumlah_saudara_tiri" type="number"
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <input name="bahasa_rumah" type="text"
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-grid">
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="alamat" rows="4">{{ $pendaftaran->alamat }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label>RT/RW</label>

                                        <input name="rt_rw" type="text" value="{{ $pendaftaran->rt_rw }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Desa</label>

                                        <input name="desa" type="text" value="{{ $pendaftaran->desa }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="jarak_rumah" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="no_hp_ortu" type="text"
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="riwayat_penyakit" rows="3">{{ $pendaftaran->riwayat_penyakit }}</textarea>
                                    </div>

                                    <div class="form-group full">
                                        <label>Kelainan Jasmani</label>

                                        <textarea name="kelainan_jasmani" rows="3">{{ $pendaftaran->kelainan_jasmani }}</textarea>
                                    </div>
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="jenjang_pendidikan" type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="lama_belajar" type="text"
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_ayah" value="{{ optional($ayah)->nama }}">
                                    </div>
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="alamat_ayah" rows="3">{{ optional($ayah)->alamat }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_ibu" value="{{ optional($ibu)->nama }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="agama_ibu" value="{{ optional($ibu)->agama }}">
                                    </div>
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="alamat_ibu" rows="3">{{ optional($ibu)->alamat }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_wali" value="{{ optional($wali)->nama }}">
                                    </div>
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="alamat_wali" rows="3">{{ optional($wali)->alamat }}</textarea>
                                    </div>
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form-grid">
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <textarea name="bakat_prestasi" rows="4">{{ $pendaftaran->bakat_prestasi }}</textarea>
                                    </div>
                                ...
                                <div class="admin-form-grid">
                                    @foreach ($documentFields as $fieldName => $documentName)
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($document)
                                                <div
                                                    style="border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px; margin-bottom: 10px; background: #f8fafc;">
                                                    @if ($isImage)
                                                    ...
                                                    @else
                                                        <div
                                                            style="height: 120px; border-radius: 10px; background: #fff; display: flex; align-items: center; justify-content: center; margin-bottom: 10px;">
                                                    ...
                                                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                                                        ...
                                                        <a href="{{ $documentUrl }}" download class="btn-cancle"
                                                            style="padding: 8px 12px; text-decoration: none;">
                                            ...
                                            @else
                                                <div
                                                    style="border: 1px dashed #cbd5e1; border-radius: 12px; padding: 16px; margin-bottom: 10px; color: #64748b; background: #f8fafc;">
                                                    Belum ada dokumen
                                                </div>
                                            @endif
    ...
    @isset($pendaftarans)
        @foreach ($pendaftarans as $pendaftaran)
            @php
                ...
                $totalLunas = $tagihan?->details?->where('status_pembayaran', 'lunas')->sum('nominal_akhir') ?? 0;

                $totalBelumBayar =
                    $tagihan?->details?->where('status_pembayaran', '!=', 'lunas')->sum('nominal_akhir') ?? 0;
            @endphp

            <div class="modal fade admin-modal" id="modalBayar{{ $pendaftaran->id }}" tabindex="-1">
            ...
            <div class="modal fade admin-modal" id="modalPrintPendaftaran{{ $pendaftaran->id }}" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- BODY -->
                        <div class="modal-body">
                            <iframe src="{{ route('admin.pendaftaran.preview', $pendaftaran->id) }}" width="100%"
                                height="700" style="border:none;">
                            </iframe>
                        </div>
                        <!-- FOOTER -->
                        <div class="modal-footer">
    ...
    @if (isset($pendaftarans) && ($canManageSelectedPeriod ?? true))
        ...
        @foreach ($pendaftarans as $pendaftaran)
            <div class="modal fade delete-modal" id="modalHapusPendaftaran{{ $pendaftaran->id }}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal fade admin-modal" id="modalTambahGelombang" tabindex="-1"
        aria-labelledby="modalTambahGelombangLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <!-- HEADER -->
                <div class="modal-header">
                ...
                <!-- BODY -->
                <div class="modal-body">
                    <form action="{{ route('gelombang.store') }}" method="POST" id="formTambahGelombang">
                        @csrf
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_gelombang"
                                        value="{{ old('nama_gelombang') }}" placeholder="Contoh : Gelombang 1">
                ...
                <!-- FOOTER -->
                <div class="modal-footer">
                    <button type="button" class="btn-cancle" data-dismiss="modal">
                        Batal
                    </button>
                    <button type="submit" form="formTambahGelombang" class="btn-save">
                        <i class="fa-solid fa-floppy-disk"></i>
                        Simpan Gelombang
                    </button>
                </div>
    ...
    @isset($gelombangs)
        ...
        @foreach ($gelombangs as $item)
            <div class="modal fade admin-modal" id="modalEditGelombang{{ $item->id }}" tabindex="-1"
                aria-labelledby="modalTambahGelombangLabel" aria-hidden="true">
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('gelombang.update', $item->id) }}" method="POST"
                                ...
                                <!-- STATUS -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="urutan"
                                                value="{{ old('urutan', $item->urutan) }}" placeholder="1">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="formEditGelombang{{ $item->id }}" class="btn-save">
    ...
    @isset($gelombangs)
        ...
        @foreach ($gelombangs as $item)
            <div class="modal fade admin-modal" id="modalViewGelombang{{ $item->id }}" tabindex="-1"
                aria-labelledby="modalTambahGelombangLabel" aria-hidden="true">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full">
                                ...
                                <input type="text" name="nama_pembayaran"
                                    placeholder="Contoh : Registrasi Pondok" value="{{ old('nama_pembayaran') }}"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nominal" class="editNominal"
                                    placeholder="Contoh : Rp 150.000" value="{{ old('nominal') }}" required>
                                @error('nominal')
                                    <small class="text-danger">
                                        {{ $message }}
                                    </small>
    ...
    @isset($pembayarans)
        ...
        @foreach ($pembayarans as $item)
            <div class="modal fade admin-modal" id="modalEditBiaya{{ $item->id }}" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <!-- FORM -->
                            ...
                            <div class="modal-body">
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" required>
                                            <option value="Biaya Tahunan"
                                                {{ $item->kategori == 'Biaya Tahunan' ? 'selected' : '' }}>
                                                Biaya Tahunan
                                            </option>
                                            <option value="Biaya Bulanan"
                                                {{ $item->kategori == 'Biaya Bulanan' ? 'selected' : '' }}>
                                                Biaya Bulanan
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group full">
                                        ...
                                        <input type="text" name="nama_pembayaran"
                                            value="{{ $item->nama_pembayaran }}" required>
                                    </div>
                                    <!-- NOMINAL -->
                                    <div class="form-group">
                                        <label>
                                        ...
                                        <input type="text" name="nominal" class="editNominal"
                                            value="Rp {{ number_format($item->nominal, 0, ',', '.') }}" required>
                                    </div>
                                </div>
                            </div>
                            <!-- FOOTER -->
    ...
    {{-- TAMBAH HASIL TES --}}
    <div class="modal fade admin-modal" id="modalTambahNilai" tabindex="-1"
        aria-labelledby="modalTambahNilaiLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- BODY -->
                <div class="modal-body">
                    <form action="{{ route('hasil-tes.store') }}" method="POST" id="formTambahNilai">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="baca_tulis_pegon" min="0" max="100"
                                        placeholder="0 - 100">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="doa_harian" min="0" max="100"
                                        placeholder="0 - 100">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ubudiyyah" min="0" max="100"
                                        placeholder="0 - 100">
                                </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="membaca_al_quran" min="0" max="100"
                                        placeholder="0 - 100">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="hafalan_surat_pendek" min="0"
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group full">
                                    ...
                                    <input type="text" name="wawancara" placeholder="Contoh : Sangat Baik">
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="formTambahNilai" class="btn-save">
                        <i class="fa-solid fa-floppy-disk"></i>
                        Simpan Nilai Tes
                    </button>
                </div>
    ...
    @isset($hasilTesModal)
        @foreach ($hasilTesModal as $hasil)
            <div class="modal fade admin-modal" id="modalEditHasil{{ $hasil->id }}" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <!-- HEADER -->
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('hasil-tes.update', $hasil->id) }}" method="POST"
                                id="formEditHasil{{ $hasil->id }}">
                                @csrf
                                <input type="hidden" name="pendaftaran_id" value="{{ $hasil->pendaftaran_id }}">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="form-group full">
                                            ...
                                            <input type="text"
                                                value="{{ $hasil->pendaftaran->nama_lengkap ?? '-' }}" disabled>
                                        </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="baca_tulis_pegon" min="0"
                                                max="100"
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="membaca_al_quran" min="0"
                                                max="100"
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="form-group full">
                                            ...
                                            <input type="text" name="wawancara"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="formEditHasil{{ $hasil->id }}" class="btn-save">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="delete-action">
                            ...
                            <form action="{{ route('hasil-tes.destroy', $hasil->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-delete-confirm">
                                    <i class="fa-solid fa-trash"></i>
    ...
    @if (request()->routeIs('admin-virtual-tour'))
        <div class="modal fade admin-modal virtual-tour-modal" id="modalTambahScene" tabindex="-1"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <form method="POST" action="{{ route('virtual-tour.scene.store') }}"
                    enctype="multipart/form-data" id="formTambahSceneVirtualTour" class="modal-content">
                    @csrf
        ...
        @if ($activeScene ?? false)
            <div class="modal fade admin-modal virtual-tour-modal" id="modalEditScene" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
            ...
            <div id="adminHotspotModals">
                @foreach ($activeScene->hotspots as $hotspot)
                    <div class="modal fade admin-modal virtual-tour-modal"
                        id="modalEditHotspot{{ $hotspot->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="modal-title-wrap">
                                ...
                                <div class="modal-body">
                                    <form method="POST"
                                        action="{{ route('virtual-tour.hotspot.update', $hotspot->id) }}"
                                        id="formEditHotspotVirtualTour{{ $hotspot->id }}"
                                        class="virtual-tour-form">
                                        @csrf
